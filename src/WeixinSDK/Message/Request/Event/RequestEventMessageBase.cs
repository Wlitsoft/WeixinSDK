...
namespace Wlitsoft.Framework.WeixinSDK.Message.Request.Event
{
    ...
    /// </summary>
    [XmlRoot("xml")]
    public abstract class RequestEventMessageBase : IRequestMessage
    {
        ...
        /// 获取 消息类型。
        /// </summary>
        public RequestMsgType MsgType => RequestMsgType.Event;
        ...
        /// </summary>
        [XmlIgnore]
        public abstract RequestMsgEventType Event { get; }
