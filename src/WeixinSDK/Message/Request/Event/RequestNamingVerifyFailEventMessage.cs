...
namespace Wlitsoft.Framework.WeixinSDK.Message.Request.Event
{
    ...
    /// </summary>
    [XmlRoot("xml")]
    public class RequestNamingVerifyFailEventMessage : RequestEventMessageBase
    {
        ...
        /// </summary>
        [XmlIgnore]
        public override RequestMsgEventType Event => RequestMsgEventType.NamingVerifyFail;
